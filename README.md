## This repository holds a conan recipe for Boost.Math.
...
### Basic setup
    ...
    $ conan install Boost.Math/1.65.1@bincrafters/stable
...
## Upload
    ...
    $ conan upload Boost.Math/1.65.1@bincrafters/stable --all -r bincrafters
