...
class TestPackageConan(ConanFile):
    ...
    def requirements(self):
        boost_deps = ['array', 'assert', 'atomic', 'concept_check', 'config', 'core', 'detail', 'fusion', 'integer', 'lambda', 'mpl', 'predef', 'range', 'smart_ptr', 'static_assert', 'throw_exception', 'tuple', 'type_traits']
